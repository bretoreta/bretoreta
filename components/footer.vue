    ...
    <footer class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div class="sm:col-span-2">
          ...
          <div class="mt-6 lg:max-w-sm">
            ...
            <p class="mt-4 text-sm">
              Every deployment is optimized for real-world impact, whether automating complex tasks or managing petabyte-scale data ecosystems.
            </p>
          </div>
        </div>
        <div class="space-y-2 text-sm">
          ...
          <div class="flex">
            ...
            <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">admin@bretoreta.me</a>
          </div>
          <div class="flex">
        ...
        <div>
          ...
          <div class="flex items-center mt-1 space-x-3">
            <a href="/" class="text-slate-300 transition-colors duration-300 hover:text-deep-purple-accent-400">
      ...
      <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-accented lg:flex-row">
        ...
        <ul class="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          <li>
            <a href="/" class="text-sm text-muted transition-colors duration-300 hover:text-deep-purple-accent-400">F.A.Q</a>
          </li>
          <li>
            <a href="/" class="text-sm text-muted transition-colors duration-300 hover:text-deep-purple-accent-400">Privacy Policy</a>
          </li>
          <li>
            <a href="/" class="text-sm text-muted transition-colors duration-300 hover:text-deep-purple-accent-400">Terms &amp; Conditions</a>
          </li>
        </ul>
      </div>
    </footer>
