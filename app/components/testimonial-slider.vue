<template>
  <div class="mx-auto w-full max-w-3xl text-center overflow-hidden">
    ...
    <div class="relative h-32">
      <div
        class="pointer-events-none absolute left-1/2 top-0 size-[300px] md:size-[480px] -translate-x-1/2 before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-linear-to-b before:from-zinc-500/25 before:via-zinc-500/5 before:via-25% before:to-zinc-500/0 before:to-75%"
      >
        <div
