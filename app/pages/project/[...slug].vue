...
<template>
  <div class="py-10 sm:py-14">
    <div v-if="project" class="mx-auto w-full max-w-7xl px-2 sm:px-6 lg:px-10">
        ...
        <div class="lg:col-span-2">
          <div>
            <div v-motion-slide-visible-once-bottom class="mb-5">
              <NuxtLink to="/project" class="inline-flex items-center gap-2 text-sm font-semibold text-muted hover:text-gray-900 dark:hover:text-white">
