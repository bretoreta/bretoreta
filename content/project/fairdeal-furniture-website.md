...
- ✅ Full UI/UX redesign and website rebuild
- ✅ Migrating to **ServerCore Cloud Hosting** for better performance
- ✅ Integrating **WordPress + WooCommerce** for scalable e-commerce
- ✅ Setting up **SEO optimization** and Google indexing
- ✅ Performance tuning (with **Cloudflare** for caching & security)
- ✅ Developing a **custom Laravel + VueJS inventory management app**
- ✅ Automating image storage via **Minio (S3-compatible)**
