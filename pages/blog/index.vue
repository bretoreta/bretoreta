    ...
    <div class="relative isolate mx-auto w-full max-w-[1440px]">
      <div class="grid lg:grid-cols-[16px_1fr_16px] gap-6">
        ...
        <div class="mt-10">
          ...
          <div v-if="data?.length" class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 dark:border-muted border-dashed pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
